...
public class QRCodeUtil {
    ...
    public static void main(String[] args) throws Exception {
    	String pathString="D:\\hello.png";
    	String context="https://zhidao.baidu.com/question/503009669.html";
    	zxingCodeCreate(context,pathString);
    	Object resultObject=zxingCodeAnalyze(pathString);
